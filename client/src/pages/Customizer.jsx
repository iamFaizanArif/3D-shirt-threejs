...
const Customizer = () => {
    ...
    const handleSubmit = async (type) => {
        ...
        try {
            //     calling our backend to generate AI Image!
            // Because we want to start loading
        ...
        //     Now we will render that image which is created by Ai
    ...
    // get file and the read the data
    const readFile = (type) => {
